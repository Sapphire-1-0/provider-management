...
CREATE (c1:Contact {use:"DIR"})
CREATE (t1:Telecom {phone:"813-357-9153", tty:"813-357-9154", fax:"813-357-9155", email:"vbalaji216@example.com", website:"https://www.RVLOC000CA001.com"})
CREATE (c1)-[:TELECOM_IS]->(t1)
CREATE (p1:Person {firstName:"Pooja", middleName:"M", lastName:"Mohanakrishnan", title:"Office Assistant"})
CREATE (c1)-[:PERSON_IS]->(p1)
CREATE (rl1)-[:HAS_LOCATION_CONTACT]->(c1)
