...
CREATE (org:Organization {
  name: "Magnolia Health Alliance",
  aliasName: "Magnolia Alliance",
  type: "PPG",
  atypical: false,
  capitated: false,
...
// --- Identifiers ---
CREATE (npi:Identifier:NPI {value: "3456789012", startDate: date("2021-02-01"), endDate: date("4000-01-01")})
CREATE (medicare:Identifier:MedicareID {value: "210001"})
CREATE (tin:Identifier:TIN {value: "333333333", legalName: "Magnolia Health Alliance Legal Entity"})
CREATE (medicaid:Identifier:MedicaidID {value: "3100001", state: "GA", startDate: date("2020-01-01"), endDate: date("4000-01-01")})
CREATE (dea:Identifier:DEA_Number {value: "D3456789", startDate: date("2019-01-01"), endDate: date("4000-01-01")})
...
// --- Qualifications ---
CREATE (q1:Qualification:License {type:"LICE_MLC", value:"LIC3456", state:"GA", startDate: date("2021-02-01"), endDate: date("4000-01-01"), status:"ACTIVE"})
...
CREATE (addr:Address {streetAddress:"200 Magnolia Blvd", secondaryAddress:"Suite 300", city:"Atlanta", state:"GA", zipCode:"30309", county:"Fulton", countyFIPS:"13121"})
CREATE (contact)-[:ADDRESS_IS]->(addr)
CREATE (telecom:Telecom {phone:"404-555-5678", tty:"404-555-5679", fax:"404-555-5680", email:"billing@magnoliaalliance.com", website:"https://www.magnoliaalliance.com"})
CREATE (contact)-[:TELECOM_IS]->(telecom)
CREATE (person:Person {firstName:"Robert", middleName:"L", lastName:"Harris", title:"Billing Manager"})
...
CREATE (loc1:Location {name:"Magnolia Clinic 1", code:"MHLOC000GA001", streetAddress:"201 Magnolia Blvd", secondaryAddress:"Suite 101", city:"Atlanta", state:"GA", zipCode:"30309", county:"Fulton", countyFIPS:"13121"})
...
// Example for loc2:
CREATE (loc2:Location {name:"Magnolia Clinic 2", code:"MHLOC000GA002", streetAddress:"202 River St", secondaryAddress:"Suite 102", city:"Savannah", state:"GA", zipCode:"31401", county:"Chatham", countyFIPS:"13051"})
...
// --- Location 3 ---
CREATE (loc3:Location {name:"Magnolia Clinic 3", code:"MHLOC000GA003", streetAddress:"303 Oak St", secondaryAddress:"Suite 103", city:"Augusta", state:"GA", zipCode:"30901", county:"Richmond", countyFIPS:"13063"})
...
// --- Location 4 ---
CREATE (loc4:Location {name:"Magnolia Clinic 4", code:"MHLOC000GA004", streetAddress:"404 Pine St", secondaryAddress:"Suite 104", city:"Columbus", state:"GA", zipCode:"31901", county:"Muscogee", countyFIPS:"13215"})
...
// --- Location 5 ---
CREATE (loc5:Location {name:"Magnolia Clinic 5", code:"MHLOC000GA005", streetAddress:"505 Maple St", secondaryAddress:"Suite 105", city:"Macon", state:"GA", zipCode:"31201", county:"Bibb", countyFIPS:"13017"})
...
// --- Location 6 ---
CREATE (loc6:Location {name:"Magnolia Clinic 6", code:"MHLOC000GA006", streetAddress:"606 Cedar St", secondaryAddress:"Suite 106", city:"Athens", state:"GA", zipCode:"30601", county:"Clarke", countyFIPS:"13059"})
...
// --- Location 7 ---
CREATE (loc7:Location {name:"Magnolia Clinic 7", code:"MHLOC000GA007", streetAddress:"707 Birch St", secondaryAddress:"Suite 107", city:"Savannah", state:"GA", zipCode:"31405", county:"Chatham", countyFIPS:"13051"})
...
// --- Location 8 ---
CREATE (loc8:Location {name:"Magnolia Clinic 8", code:"MHLOC000GA008", streetAddress:"808 Walnut St", secondaryAddress:"Suite 108", city:"Columbus", state:"GA", zipCode:"31904", county:"Muscogee", countyFIPS:"13215"})
...
// --- Location 9 ---
CREATE (loc9:Location {name:"Magnolia Clinic 9", code:"MHLOC000GA009", streetAddress:"909 Chestnut St", secondaryAddress:"Suite 109", city:"Macon", state:"GA", zipCode:"31204", county:"Bibb", countyFIPS:"13017"})
...
// --- Location 10 ---
CREATE (loc10:Location {name:"Magnolia Clinic 10", code:"MHLOC000GA010", streetAddress:"1010 Poplar St", secondaryAddress:"Suite 110", city:"Athens", state:"GA", zipCode:"30606", county:"Clarke", countyFIPS:"13059"})
...
// --- DIR Contacts, OSHPD IDs, Capacities, Qualifications for loc1 → loc10 ---
CREATE (c1:Contact {use:"DIR"})
CREATE (t1:Telecom {phone:"404-10101", tty:"404-10102", fax:"404-10103", email:"MHLOC000GA001@example.com", website:"https://www.MHLOC000GA001.com"})
CREATE (c1)-[:TELECOM_IS]->(t1)
CREATE (p1:Person {firstName:"Sophia", middleName:"A", lastName:"Green", title:"Director"})
...
CREATE (loc1)-[:HAS_CAPACITY]->(:Capacity {type:"MCD_AC", value:105})
CREATE (loc1)-[:HAS_CAPACITY]->(:Capacity {type:"MCR_AC", value:155})
CREATE (loc1)-[:HAS_CAPACITY]->(:Capacity {type:"EXCH_AC", value:205})
CREATE (loc1)-[:HAS_QUALIFICATION]->(:Qualification:Certification {type:"CERT_DHSSE", startDate:date("2021-02-01"), endDate:date("4000-01-01")})

// --- Location 2: Peachtree Clinic 2 ---
CREATE (c2:Contact {use:"DIR"})
CREATE (t2:Telecom {phone:"912-555-2020", tty:"912-555-2021", fax:"912-555-2022", email:"PHLOC000GA002@example.com", website:"https://www.PHLOC000GA002.com"})
...
CREATE (t3:Telecom {phone:"706-555-3030", tty:"706-555-3031", fax:"706-555-3032", email:"PHLOC000GA003@example.com", website:"https://www.PHLOC000GA003.com"})
...
CREATE (t4:Telecom {phone:"478-555-4040", tty:"478-555-4041", fax:"478-555-4042", email:"PHLOC000GA004@example.com", website:"https://www.PHLOC000GA004.com"})
...
CREATE (t5:Telecom {phone:"706-555-5050", tty:"706-555-5051", fax:"706-555-5052", email:"PHLOC000GA005@example.com", website:"https://www.PHLOC000GA005.com"})
...
CREATE (t6:Telecom {phone:"706-555-6060", tty:"706-555-6061", fax:"706-555-6062", email:"PHLOC000GA006@example.com", website:"https://www.PHLOC000GA006.com"})
...
CREATE (t7:Telecom {phone:"229-555-7070", tty:"229-555-7071", fax:"229-555-7072", email:"PHLOC000GA007@example.com", website:"https://www.PHLOC000GA007.com"})
...
CREATE (t8:Telecom {phone:"770-555-8080", tty:"770-555-8081", fax:"770-555-8082", email:"PHLOC000GA008@example.com", website:"https://www.PHLOC000GA008.com"})
...
CREATE (t9:Telecom {phone:"678-555-9090", tty:"678-555-9091", fax:"678-555-9092", email:"PHLOC000GA009@example.com", website:"https://www.PHLOC000GA009.com"})
...
CREATE (t10:Telecom {phone:"404-555-1010", tty:"404-555-1011", fax:"404-555-1012", email:"PHLOC000GA010@example.com", website:"https://www.PHLOC000GA010.com"})
