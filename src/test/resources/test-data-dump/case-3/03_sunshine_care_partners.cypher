...
CREATE (org:Organization {
  ...
  aliasName: "Sunshine Partners",
  type: "PPG",
  atypical: false,
  capitated: false,
  pcpPractitionerRequired: false,
  code: "SHPFL1234567890"
})

// --- Identifiers ---
CREATE (npi:Identifier:NPI {value: "3456789012", startDate: date("2020-01-01"), endDate: date("4000-01-01")})
CREATE (medicare:Identifier:MedicareID {value: "300002"})
CREATE (tin:Identifier:TIN {value: "333333333", legalName: "Sunshine Health Partners Legal Entity"})
CREATE (medicaid:Identifier:MedicaidID {value: "4000001", state: "FL", startDate: date("2019-01-01"), endDate: date("4000-01-01")})
CREATE (dea:Identifier:DEA_Number {value: "D3456789", startDate: date("2018-01-01"), endDate: date("4000-01-01")})
...
// --- Qualifications ---
CREATE (q1:Qualification:License {type:"LICE_MLC", value:"LIC3456", state:"FL", startDate: date("2020-01-01"), endDate: date("4000-01-01"), status:"ACTIVE"})
...
CREATE (addr:Address {streetAddress:"200 Sunshine Blvd", secondaryAddress:"Suite 300", city:"Miami", state:"FL", zipCode:"33101", county:"Miami-Dade", countyFIPS:"08601"})
CREATE (contact)-[:ADDRESS_IS]->(addr)
CREATE (telecom:Telecom {phone:"305-555-1234", tty:"305-555-1235", fax:"305-555-1236", email:"billing@SunshinePartners.com", website:"https://www.SunshinePartners.com"})
CREATE (contact)-[:TELECOM_IS]->(telecom)
CREATE (person:Person {firstName:"John", middleName:"T", lastName:"Doe", title:"Billing Manager"})
...
CREATE (loc1:Location {name:"Sunshine Clinic 1", code:"SHLOC000FL001", streetAddress:"101 Ocean Dr", secondaryAddress:"Suite 101", city:"Miami", state:"FL", zipCode:"33101", county:"Miami-Dade", countyFIPS:"08601"})
...
// Repeat loc2 → loc10 similarly with FL cities: Tampa, Orlando, Jacksonville, Tallahassee, Fort Lauderdale, St. Petersburg, Naples, Sarasota, Gainesville
...
// --- DIR Contacts, OSHPD IDs, Capacities, Qualifications Example ---
CREATE (c1:Contact {use:"DIR"})
CREATE (t1:Telecom {phone:"305-00101", tty:"305-00102", fax:"305-00103", email:"SHLOC000FL001@example.com", website:"https://www.SHLOC000FL001.com"})
...
CREATE (osh1:Identifier:OSHPD_ID {value:"OSHPD_SHLOC000FL001"})
...
// --- Location 2: Tampa ---
CREATE (loc2:Location {name:"Sunshine Clinic 2", code:"SHLOC000FL002", streetAddress:"202 Bayshore Blvd", secondaryAddress:"Suite 202", city:"Tampa", state:"FL", zipCode:"33606", county:"Hillsborough", countyFIPS:"12057"})
...
CREATE (t2:Telecom {phone:"813-00202", tty:"813-00203", fax:"813-00204", email:"SHLOC000FL002@example.com", website:"https://www.SHLOC000FL002.com"})
...
CREATE (osh2:Identifier:OSHPD_ID {value:"OSHPD_SHLOC000FL002"})
...
// --- Location 3: Orlando ---
CREATE (loc3:Location {name:"Sunshine Clinic 3", code:"SHLOC000FL003", streetAddress:"303 Lake Ave", secondaryAddress:"Suite 303", city:"Orlando", state:"FL", zipCode:"32801", county:"Orange", countyFIPS:"12095"})
...
CREATE (t3:Telecom {phone:"407-00303", tty:"407-00304", fax:"407-00305", email:"SHLOC000FL003@example.com", website:"https://www.SHLOC000FL003.com"})
...
CREATE (osh3:Identifier:OSHPD_ID {value:"OSHPD_SHLOC000FL003"})
...
CREATE (loc4:Location {name:"Sunshine Clinic 4", code:"SHLOC000FL004", streetAddress:"404 River St", secondaryAddress:"Suite 404", city:"Jacksonville", state:"FL", zipCode:"32202", county:"Duval", countyFIPS:"12031"})
...
CREATE (t4:Telecom {phone:"904-00404", tty:"904-00405", fax:"904-00406", email:"SHLOC000FL004@example.com", website:"https://www.SHLOC000FL004.com"})
...
CREATE (osh4:Identifier:OSHPD_ID {value:"OSHPD_SHLOC000FL004"})
...
CREATE (loc5:Location {name:"Sunshine Clinic 5", code:"SHLOC000FL005", streetAddress:"505 Capital St", secondaryAddress:"Suite 505", city:"Tallahassee", state:"FL", zipCode:"32301", county:"Leon", countyFIPS:"12073"})
...
CREATE (t5:Telecom {phone:"850-00505", tty:"850-00506", fax:"850-00507", email:"SHLOC000FL005@example.com", website:"https://www.SHLOC000FL005.com"})
...
CREATE (osh5:Identifier:OSHPD_ID {value:"OSHPD_SHLOC000FL005"})
...
CREATE (loc6:Location {name:"Sunshine Clinic 6", code:"SHLOC000FL006", streetAddress:"606 Ocean Blvd", secondaryAddress:"Suite 606", city:"Fort Lauderdale", state:"FL", zipCode:"33301", county:"Broward", countyFIPS:"12011"})
...
CREATE (t6:Telecom {phone:"954-00606", tty:"954-00607", fax:"954-00608", email:"SHLOC000FL006@example.com", website:"https://www.SHLOC000FL006.com"})
...
CREATE (osh6:Identifier:OSHPD_ID {value:"OSHPD_SHLOC000FL006"})
...
CREATE (loc7:Location {name:"Sunshine Clinic 7", code:"SHLOC000FL007", streetAddress:"707 Beach Dr", secondaryAddress:"Suite 707", city:"St. Petersburg", state:"FL", zipCode:"33701", county:"Pinellas", countyFIPS:"12103"})
...
CREATE (t7:Telecom {phone:"727-00707", tty:"727-00708", fax:"727-00709", email:"SHLOC000FL007@example.com", website:"https://www.SHLOC000FL007.com"})
...
CREATE (osh7:Identifier:OSHPD_ID {value:"OSHPD_SHLOC000FL007"})
...
// --- Location 8: Naples ---
CREATE (loc8:Location {name:"Sunshine Clinic 8", code:"SHLOC000FL008", streetAddress:"808 Gulf Shore Blvd", secondaryAddress:"Suite 808", city:"Naples", state:"FL", zipCode:"34102", county:"Collier", countyFIPS:"12021"})
...
CREATE (t8:Telecom {phone:"239-00808", tty:"239-00809", fax:"239-00810", email:"SHLOC000FL008@example.com", website:"https://www.SHLOC000FL008.com"})
...
CREATE (osh8:Identifier:OSHPD_ID {value:"OSHPD_SHLOC000FL008"})
...
// --- Location 9: Sarasota ---
CREATE (loc9:Location {name:"Sunshine Clinic 9", code:"SHLOC000FL009", streetAddress:"909 Main St", secondaryAddress:"Suite 909", city:"Sarasota", state:"FL", zipCode:"34236", county:"Sarasota", countyFIPS:"12115"})
...
CREATE (t9:Telecom {phone:"941-00909", tty:"941-00910", fax:"941-00911", email:"SHLOC000FL009@example.com", website:"https://www.SHLOC000FL009.com"})
CREATE (c9)-[:TELECOM_IS]->(t9)
CREATE (p9:Person {firstName:"Isabella", middleName:"S", lastName:"Martinez", title:"Director"})
CREATE (c9)-[:PERSON_IS]->(p9)
CREATE (rl9)-[:HAS_LOCATION_CONTACT]->(c9)

CREATE (osh9:Identifier:OSHPD_ID {value:"OSHPD_SHLOC000FL009"})
...
CREATE (loc9)-[:HAS_CAPACITY]->(:Capacity {type:"EXCH_AC", value:180})
...
CREATE (loc10:Location {name:"Sunshine Clinic 10", code:"SHLOC000FL010", streetAddress:"1010 University Ave", secondaryAddress:"Suite 1010", city:"Gainesville", state:"FL", zipCode:"32601", county:"Alachua", countyFIPS:"12001"})
...
CREATE (t10:Telecom {phone:"352-01010", tty:"352-01011", fax:"352-01012", email:"SHLOC000FL010@example.com", website:"https://www.SHLOC000FL010.com"})
CREATE (c10)-[:TELECOM_IS]->(t10)
CREATE (p10:Person {firstName:"James", middleName:"T", lastName:"Anderson", title:"Director"})
CREATE (c10)-[:PERSON_IS]->(p10)
CREATE (rl10)-[:HAS_LOCATION_CONTACT]->(c10)

CREATE (osh10:Identifier:OSHPD_ID {value:"OSHPD_SHLOC000FL010"})
