...
//        String cypher = cypherLoader.load("get_organizations_with_identifiers.cypher");
    ...
    public Organization createOrganization(OrganizationDto organizationDto) {
        ...
        // -----------------------------------------------------------------------------------
        List<IdentifierDto> identifiers = organizationDto.getIdentifiers();
        ...
        if(organizationDto.getContacts() != null && !organizationDto.getContacts().isEmpty()){
            ...
            List<Map<String, Object>> contacts = DataExtractor.getContacts(organizationDto.getContacts());
        ...
        if (organizationDto.getNetworks() != null && !organizationDto.getNetworks().isEmpty()){
            List<Map<String, Object>> networks = DataExtractor.getNetworks(organizationDto.getNetworks());
